...
import { Search, Plus, RefreshCw, Filter, ChevronRight } from 'lucide-react';
      ...
      {!isLoading && !isError && filteredItems.length > 0 && (
        <div className="bg-white border border-slate-200 rounded-md shadow-xs overflow-hidden">
          ...
          <div className="p-2.5 bg-slate-50 border-t border-slate-200 text-slate-500 text-[11px] flex justify-between items-center">
            <span>Showing {filteredItems.length} of {rawItems.length} registered endpoints</span>
            <span>Refreshes automatically every 30s</span>
          </div>
        </div>
      )}
